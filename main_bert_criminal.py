...
# model_setting = {'mode': 'train_factor', 'train_data': 'gun'}
# model_setting = {'mode': 'pred_sentence', 'train_data': 'gun', 'pred_data':'全文標註的測試句2'}
model_setting = {'mode': 'pred_factor', 'train_data': 'gun', 'pred_data':'全文標註的測試句2'}


# Add factor_lst
if model_setting['train_data']=='gun':
    model_setting['factor_lst'] = ['犯罪後之態度', '犯罪所生之危險或違反義務之程度', '被告之品行', '其他審酌事項']
