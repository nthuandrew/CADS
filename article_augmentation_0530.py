...
for i in range(1, 6):
    augment_df1 = pd.read_excel(f'data/final/article/A1_be_augment_1_0530_fold_{i}.xlsx').fillna("")
    augment_df2 = pd.read_excel(f'data/final/article/A1_be_augment_0_0530_fold_{i}.xlsx').fillna("")
    origin_df = pd.read_excel(f'data/final/article/A1_train_moveAug_0530_fold_{i}.xlsx').fillna("")
    ...
    augmented_df_v2 = augmented_df_v2.sample(frac=1, random_state=seed).reset_index(drop=True)
    # augmented_df.to_excel('data/article/train_augmented_1_v4.xlsx')
    augmented_df_v2.to_excel(f'data/final/article/A1_train_augmented_0530_fold_{i}.xlsx')
