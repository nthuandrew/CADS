...
class BertForClassification(BertPreTrainedModel):
    def __init__(self, config, *model_args, **model_kwargs):
        ...
        # self.conv1 = nn.Conv2d(in_channels=4, out_channels=chans, kernel_size=(1, int(embedding_size)), padding="valid")
        # self.pool1 = nn.AvgPool2d(kernel_size=(input_size, 1))
        # self.flat = nn.Flatten()
        # self.middle_base = nn.Linear(num_encoder_hidden, 76)
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,labels=None):
        ...
        # print(cls_vector.shape)
        # logits = self.middle_base(cls_vector)
        # without dropout
